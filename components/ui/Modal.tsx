  ...
  switch (result) {
    case "win":
      modalContent = (
        <div
          ref={modalRef}
          className="modal relative p-6 bg-white shadow-lg rounded-lg items-center "
        >
          <div className="modal relative p-6 rounded-lg flex justify-center items-center flex-col">
            <Gem
              size={100}
              color="green"
