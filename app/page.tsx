...
export const metadata: Metadata = {
  title:
    "Fake Stake - Free Online Casino Games | Play Mines, Plinko, Roulette, Blackjack & More",
  description:
    "Play the best free casino games online! Experience Mines, Plinko, Dice, Limbo, Roulette, Blackjack & Flip games with virtual currency. No real money, no risk - pure entertainment and practice.",
  openGraph: {
    title: "Fake Stake - Free Online Casino Games | No Real Money Required",
    description:
      "Play Mines, Plinko, Roulette, Blackjack, Dice, Limbo & Flip games for free with virtual currency. Perfect for practice and entertainment!",
  },
};
          ...
          <div className="mb-8 animate-fade-in">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-success/10 border border-success/20 mb-6">
              <span className="text-success text-sm font-medium">
                🎉 New Flip Game Added! 🐉 Dragon Tower is next! 🚀
              </span>
            </div>
