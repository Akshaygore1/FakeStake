          ...
          {games.map((game, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 w-full p-4 text-center">
                <h2 className="text-4xl font-bold text-white drop-shadow-lg group-hover:text-success transition-colors duration-300">
                  {game.name}
                </h2>
              </div>
              <div className="absolute bottom-0 left-0 w-full h-1 bg-success/0 group-hover:bg-success/20 transition-all duration-300" />
            </Link>
          ))}
        </div>
      </section>
